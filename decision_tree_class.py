...
class decision_tree:
    ...
    def __init__(self, df, ml_task, counter=0, min_samples=2, max_depth=5, random_subspace=None):
        self.tree = self.decision_tree_algorithm(df, ml_task, counter, min_samples, max_depth, random_subspace)
    ...
    def decision_tree_algorithm(self, df, ml_task, counter=0, min_samples=2, max_depth=5, random_subspace=None):
        # data preparations
        if counter == 0:
        ...
        # recursive part
            ...
            yes_answer = self.decision_tree_algorithm(data_below, ml_task, counter, min_samples, max_depth, random_subspace)
            no_answer = self.decision_tree_algorithm(data_above, ml_task, counter, min_samples, max_depth, random_subspace)
