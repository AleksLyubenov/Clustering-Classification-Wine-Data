...
if __name__ == "__main__":
    ...
    #TRAIN = load_obj('TRAINC')                      # For Naive Embeddings
    #TEST = load_obj('TESTC')                        # For Naive Embeddings
    ...
    save_obj(decision_tree_obj, 'DECISION_TREE_FINAL_GENSIM')
    ...
    save_obj(pruned_decision_tree_obj, 'PRUNED_DECISION_TREE_FINAL_GENSIM')
    ...
    #save_obj(random_forest_obj, 'RANDOM_FOREST_FINAL_NAIVE')
    #random_forest_obj = load_obj('RANDOM_FOREST_FINAL_NAIVE')
